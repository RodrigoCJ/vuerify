      ...
      <v-card width="500" class="mx-auto mt-5">
        ...
        <v-card-text>
          <v-form>
            ...
            <v-text-field label="Password" prepend-icon="mdi-lock" :append-icon="exibir ? 'mdi-eye' : 'mdi-eye-off'" :type="exibir ? 'text' : 'password'" @click:append="() => (exibir = !exibir)"></v-text-field>
          </v-form>
        </v-card-text>
        <v-card-actions>
